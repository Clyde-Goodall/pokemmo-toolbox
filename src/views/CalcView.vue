  ...
  <main>
    <div class="calc-container">
      <div class="search-row">
        <input type="text" ref="name" placeholder="e.g. Breloom" value="breloom"  @keydown="console.log(name.value)"/> <input type="button" @click="pkmn.addMon(name)" value="+"/>
      </div>
